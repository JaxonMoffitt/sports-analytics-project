...
function About() {
  return (
    <span>
        ...
        <div style={{display: 'flex',  justifyContent:'center'}} >
            <p className="body-text">
            The definition of a successful player is often a very arbitrary matter within the NFL, so we decided to utilize a well-respected site’s definition: Pro-Football-Reference.com’s metric of Average Value. Their formula consists of a few different levels, but essentially assigns a value to each player based on the points, yards, and possessions they are responsible for within a game. It serves a similar purpose to the win shares statistic that has become prevalent in some of the other major sports.        </p>
            </div>

        <div style={{display: 'flex',  justifyContent:'center'}} >
            <p className="body-text">
        If you want to learn more about the Average Value metric, check out <a href="https://www.pro-football-reference.com/blog/index37a8.html">Pro Football Reference's Writeup</a> explaining the nitty gritty details about the metric and how it's calculated. </p>
        </div>
